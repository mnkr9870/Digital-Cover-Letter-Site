    ...
    <div className=" max-w-10xl h-screen px-6 py-6 bg-black">
      <div className="flex flex-col min-w-full min-h-full ">
        <div className="absolute w-max">
          <h1 className="overflow-hidden whitespace-nowrap py-1 pr-5 text-3xl md:text-4xl lg:text-6xl text-white font-bold">
            Beyond
          </h1>
          <h1 className="animate-typing overflow-hidden whitespace-nowrap py-1 pr-5 text-3xl md:text-4xl lg:text-6xl text-cyan-400 font-bold">
            PDFs
          </h1>
          <h1 className="overflow-hidden whitespace-nowrap py-1 pr-5 text-3xl  md:text-4xl lg:text-6xl text-white font-bold">
            and
        ...
        <p className="absolute text-3xl font-bold tracking-tight text-white md:text-4xl lg:text-6xl  right-10 bottom-10  lg:max-w-md  text-center lg:text-right">
          Crafting Interactive <br />
          <span className=" text-cyan-400">Digital Cover Letters</span>{" "}
        </p>

        <img
          className="absolute z-0  w-full py-10 h-4/5 lg:h-full lg:top-0 left-0  object-contain "
          src={hero}
          alt="Nanda Kishore"
        ></img>
        <div
          className="relative max-w-2xl min-h-full z-100   
                        mx-auto text-center pt-60 sm:pt-60 md:pt-70 lg:pt-80 xl:pt-70"
        >
          ...
          <p className="mt-5 px-3 text-lg leading-8 text-white rounded-lg ">
            I am{" "}
          ...
          <div className="mt-5 flex flex-col items-center justify-center gap-x-6 gap-y-4">
            {/* <a
              href="#"
