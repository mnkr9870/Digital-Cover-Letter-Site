  ...
  return (
    <div className="mx-auto max-w-10xl h-screen bg-black content-center">
      <div className="mx-auto max-w-7x h-4/5 flex flex-col gap-5">
        ...
        <div className="flex justify-center w-full h-2/4 mt-10 content-center ">
          <img
            className="w-[300px] h-[300px] lg:top-0  object-contain rounded-full  shadow-2xl shadow-cyan-400"
            src={hero}
            alt="Nanda Kishore"
          ></img>
        </div>
        <div className="mt-20 flex justify-center gap-4 md:gap-6">
          <a href="#">
            <div>
              <svg
