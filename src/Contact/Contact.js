    ...
    <div className="mx-auto max-w-10xl h-screen bg-black content-center">
      <div className="mx-auto max-w-7x h-4/5 flex flex-col gap-5">
        <div className="w-full h-1/4">
          <h1 className="text-2xl px-5 font-bold tracking-tight text-cyan-400 lg:text-4xl  text-center pt-2 md:pt-10">
        ...
        <div className="flex justify-center w-full h-2/4 sm:mt-5 md:mt-10 content-center ">
          <img
            className="sm:w-[150px] sm:h-[150px] md:w-[200px] md:h-[200px] lg:w-[300px] lg:h-[300px] lg:top-0  object-contain rounded-full  shadow-2xl shadow-amber-400"
            src={hero}
            alt="Nanda Kishore"
          ></img>
        </div>
